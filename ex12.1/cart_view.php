...
<body>
    ...
    <main>
        ...
        <?php endif; ?>
        <p><a href="./index.php?action=show_add_item">Add Item</a></p>
        <p><a href="./index.php?action=empty_cart">Empty Cart</a></p>
        <p><a href="./index.php?action=end_session">End Session and Delete Cookie</a></p>
